             ...
             <Routes>
                <Route path="/">
                  ...
                  <Route path="users">
                    ...
                    <Route path="Usnew" element={<UsNew inputs = {userInputs} title="Add new user"/>}/>
                  </Route>
                  <Route path="books">
                    <Route index element={<BkList/>}/>
                    <Route path=":bookId" element={<BkSingle/>}/>
                    <Route path="Bknew" element={<BkNew inputs = {bookInputs} title="Add new book"/>}/>
                  </Route>
                  <Route path="authers">
                    <Route index element={<AuList/>}/>
                    <Route path=":autherId" element={<AuSingle/>}/>
                    <Route path="Aunew" element={<AuNew inputs = {autherInputs} title="Add new auther"/>}/>
                  </Route>
                  <Route path="languages">
                    <Route index element={<LanList/>}/>
                    <Route path="LanNew" element={<LanNew inputs = {languageInputs} title="Add new Language"/>}/>
                  </Route>
                  <Route path="genres">
                    <Route index element={<GenList/>}/>
                    <Route path="GenNew" element={<GenNew inputs = {genreInputs} title="Add new Genre"/>}/>
                  </Route>
                 </Route>
             </Routes>
          </BrowserRouter>
